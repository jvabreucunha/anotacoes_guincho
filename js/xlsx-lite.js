...
(() => {
  ...
  const STYLES = XML_HEADER
    ...
    + '<border><left style="thin"><color rgb="FFB7C2D4"/></left><right style="thin"><color rgb="FFB7C2D4"/></right><top style="thin"><color rgb="FFB7C2D4"/></top><bottom style="thin"><color rgb="FFB7C2D4"/></bottom><diagonal/></border>'
    + '<border><left/><right/><top style="thin"><color rgb="FF0A1830"/></top><bottom style="double"><color rgb="FF0A1830"/></bottom><diagonal/></border>'
    + '</borders>'
